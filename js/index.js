...
// x axis
const time1 = [
  0.01, 0.89, 3.37, 6.07, 9.19, 12.17, 15.15, 18.12, 21.10, 24.08, 27.05, 30.03, 33.01, 35.98, 38.96, 41.94, 44.91, 47.89,
  50.87, 53.84, 56.82, 59.80, 62.77, 65.75, 68.73, 71.70, 74.68, 77.66, 80.63,83.61,86.59 ,89.56, 92.54,
  95.52, 98.49,101.47,104.45, 107.42, 110.33,113.58, 116.15, 118.50, 119.40,121.14, 121.48, 123.84,
  123.84,126.73, 126.23, 127.40, 128.95,
    
];
// y axis
const elongation1 = [
  0.38, 0.43, 0.45, 0.48, 0.50, 0.51, 0.52, 0.53, 0.54, 0.55, 0.56, 0.57, 0.58, 0.58, 0.59, 0.60, 0.61, 0.62, 0.62, 0.63, 0.64, 0.64, 0.65,
  0.66, 0.66, 0.68,0.67,0.68,0.69,0.70,0.70 ,0.71, 0.72, 0.73, 0.74,0.74, 0.76, 0.78, 0.80 ,0.83, 0.86 , 0.90 ,0.90 ,0.94,
  0.96,1.03,1.03,1.10,1.04,1.16,1.33,
   
];

const time2 =[
  0.01,2.71,4.94,7.13,10.16,13.16,16.27,19.12,22.09,25.07,28.05,31.02,34.00,36.97,39.90,42.93,45.84,48.88,
  51.86,54.93,57.81,60.79,63.76,66.93,69.65,72.69,75.73,78.78,81.45,84.60,87.18,89.71,89.89,92.54,
  94.78,95.52,97.62,97.83,99.99,101.29,102.70,104.03,
  
];

const elongation2 =[
  0.41,0.45,0.50,0.54,0.57,0.60,0.61,0.63,0.65,0.67,0.68,0.70,0.71,0.73,0.75,0.78,0.79,0.81,0.83,0.84,0.86,0.88,
  0.90,0.92,0.94,0.96,0.98,1.01,1.03,1.06,1.10,1.14,1.10,1.16,1.21,1.18,1.24,1.19,1.28,1.32,1.38,1.45,

];

const time3 = [
  0.01, 0.02, 0.03, 1.12, 1.3, 1.61, 1.52, 3.57, 5.39, 7.21, 9.16, 10.70, 12.48, 12.17, 13.91, 15.08, 14.55, 15.81, 14.82, 16.13,
];

const elongation3 = [
0.87, 0.78, 0.75, 0.92, 0.83, 1.01, 0.97, 1.06, 1.11, 1.15, 1.91, 1.24, 1.31, 1.27, 1.36, 1.45, 1.40, 1.53, 1.49, 1.59,
];
  ...
  modal = new Modal({
    ...
    body: [
      ...
      },
      {
        ...
        options: ["The slope of the strain-time graph increases with temperature and stress", 
